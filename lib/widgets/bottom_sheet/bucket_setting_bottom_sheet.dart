...
class BucketSettingBottomSheet extends StatefulWidget {
  final Bucket currentBucket;
  final Function(Map<String, dynamic>) onSettingBucket;

  const BucketSettingBottomSheet({
    super.key,
    required this.currentBucket,
    required this.onSettingBucket,
  });

  @override
  State<BucketSettingBottomSheet> createState() => _BucketSettingBottomSheetState();
}

class _BucketSettingBottomSheetState extends State<BucketSettingBottomSheet> {
          ...
          Row(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child:
                    const Text('OK', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 22)),
              ),
            ],
          ),
        ],
