...
class TaskBlockDialog extends StatefulWidget {
  ...
  const TaskBlockDialog(this._textController, {Key? key, required this.onSubmitted, required this.onSetting})
      : super(key: key);

  @override
  State<TaskBlockDialog> createState() => _TaskBlockDialogState();
}
